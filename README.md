...
## This fork: English only

Course content lives directly under **`chapters/`** — e.g. `chapters/chapter0/`, `chapters/chapter1/`, … (no `chapters/en/`). For the full course and other languages, see the [upstream repo](https://github.com/huggingface/course).

### Translating the course (upstream)
